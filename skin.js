...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el=me._screentint_eggfound=document.createElement('div');
		el.ggId="screentint_eggfound";
		...
		me._screentint_eggfound.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._screentint_eggfound.logicBlock_visible = function() {
			...
			if (me._screentint_eggfound.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._screentint_eggfound.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._screentint_eggfound.style[domTransition]='';
				if (me._screentint_eggfound.ggCurrentLogicStateVisible == 0) {
					me._screentint_eggfound.style.visibility=(Number(me._screentint_eggfound.style.opacity)>0||!me._screentint_eggfound.style.opacity)?'inherit':'hidden';
					me._screentint_eggfound.ggVisible=true;
				}
				else {
					me._screentint_eggfound.style.visibility="hidden";
					me._screentint_eggfound.ggVisible=false;
				}
			}
		}
		me._screentint_eggfound.onclick=function (e) {
			player.setVariableValue('vis_egg_popup', false);
			me._info_eggtitle.ggText="";
			me._info_eggtitle.ggTextDiv.innerHTML=me._info_eggtitle.ggText;
			if (me._info_eggtitle.ggUpdateText) {
			...
			if (me._info_eggtitle.ggUpdatePosition) {
				me._info_eggtitle.ggUpdatePosition();
			}
			me._info_eggtitle.ggTextDiv.scrollTop = 0;
			me._info_eggtext_body.ggText="";
			me._info_eggtext_body.ggTextDiv.innerHTML=me._info_eggtext_body.ggText;
			if (me._info_eggtext_body.ggUpdateText) {
				me._info_eggtext_body.ggUpdateText=function() {
					var hs="";
					if (hs!=this.ggText) {
						this.ggText=hs;
						this.ggTextDiv.innerHTML=hs;
			...
			if (me._info_eggtext_body.ggUpdatePosition) {
				me._info_eggtext_body.ggUpdatePosition();
			}
			me._info_eggtext_body.ggTextDiv.scrollTop = 0;
		}
		me._screentint_eggfound.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._screentint_eggfound);
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		el=me._count_status0=document.createElement('div');
		els=me._count_status0__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._count_status0.ggUpdateText=function() {
		...
		me._count_status0.ggUpdateText();
		player.addListener('timer', function() {
			me._count_status0.ggUpdateText();
		});
		el.appendChild(els);
		me._count_status0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._count_status0.logicBlock_text = function() {
			...
			if (me._count_status0.ggCurrentLogicStateText != newLogicStateText) {
				me._count_status0.ggCurrentLogicStateText = newLogicStateText;
				me._count_status0.style[domTransition]='';
				if (me._count_status0.ggCurrentLogicStateText == 0) {
					me._count_status0.ggText="Start hunting for hidden eggs!";
					me._count_status0__text.innerHTML=me._count_status0.ggText;
					if (me._count_status0.ggUpdateText) {
					me._count_status0.ggUpdateText=function() {
						var hs="Start hunting for hidden eggs!";
						if (hs!=this.ggText) {
							this.ggText=hs;
							this.ggTextDiv.innerHTML=hs;
							if (this.ggUpdatePosition) this.ggUpdatePosition();
						...
						if (me._count_status0.ggUpdatePosition) me._count_status0.ggUpdatePosition();
					}
				}
				else if (me._count_status0.ggCurrentLogicStateText == 1) {
					me._count_status0.ggText="You have viewed all the hotspots";
					me._count_status0__text.innerHTML=me._count_status0.ggText;
					if (me._count_status0.ggUpdateText) {
					me._count_status0.ggUpdateText=function() {
					...
					me._count_status0.ggText="You have found "+player.getVariableValue('my_total_count')+" out of 20 eggs.";
					me._count_status0__text.innerHTML=me._count_status0.ggText;
					if (me._count_status0.ggUpdateText) {
					me._count_status0.ggUpdateText=function() {
						var hs="You have found "+player.getVariableValue('my_total_count')+" out of 20 eggs.";
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
		...
		me._svg_12.logicBlock_visible = function() {
			...
			if (me._svg_12.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._svg_12.style[domTransition]='';
				...
				else if (me._svg_12.ggCurrentLogicStateVisible == 1) {
					me._svg_12.style.visibility=(Number(me._svg_12.style.opacity)>0||!me._svg_12.style.opacity)?'inherit':'hidden';
					me._svg_12.ggVisible=true;
				}
				else if (me._svg_12.ggCurrentLogicStateVisible == 2) {
					me._svg_12.style.visibility=(Number(me._svg_12.style.opacity)>0||!me._svg_12.style.opacity)?'inherit':'hidden';
					me._svg_12.ggVisible=true;
				}
				else if (me._svg_12.ggCurrentLogicStateVisible == 3) {
					me._svg_12.style.visibility=(Number(me._svg_12.style.opacity)>0||!me._svg_12.style.opacity)?'inherit':'hidden';
					me._svg_12.ggVisible=true;
				}
				else if (me._svg_12.ggCurrentLogicStateVisible == 4) {
					me._svg_12.style.visibility=(Number(me._svg_12.style.opacity)>0||!me._svg_12.style.opacity)?'inherit':'hidden';
					me._svg_12.ggVisible=true;
				}
				else {
		...
		me._visible_counters.appendChild(me._svg_12);
		...
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
		...
		me._svg_11.logicBlock_visible = function() {
			...
			if (me._svg_11.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._svg_11.style[domTransition]='';
				...
				else if (me._svg_11.ggCurrentLogicStateVisible == 1) {
					me._svg_11.style.visibility=(Number(me._svg_11.style.opacity)>0||!me._svg_11.style.opacity)?'inherit':'hidden';
					me._svg_11.ggVisible=true;
				}
				else if (me._svg_11.ggCurrentLogicStateVisible == 2) {
					me._svg_11.style.visibility=(Number(me._svg_11.style.opacity)>0||!me._svg_11.style.opacity)?'inherit':'hidden';
					me._svg_11.ggVisible=true;
				}
				else if (me._svg_11.ggCurrentLogicStateVisible == 3) {
					me._svg_11.style.visibility=(Number(me._svg_11.style.opacity)>0||!me._svg_11.style.opacity)?'inherit':'hidden';
					me._svg_11.ggVisible=true;
				}
				else if (me._svg_11.ggCurrentLogicStateVisible == 4) {
					me._svg_11.style.visibility=(Number(me._svg_11.style.opacity)>0||!me._svg_11.style.opacity)?'inherit':'hidden';
					me._svg_11.ggVisible=true;
				}
				else {
		...
		me._visible_counters.appendChild(me._svg_11);
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
			''+
			''+
			'';
		...
		me._svg_10.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getCurrentNode() == "node1")) && 
			...
			if (me._svg_10.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._svg_10.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._svg_10.style[domTransition]='';
				if (me._svg_10.ggCurrentLogicStateVisible == 0) {
				...
				else if (me._svg_10.ggCurrentLogicStateVisible == 1) {
					me._svg_10.style.visibility=(Number(me._svg_10.style.opacity)>0||!me._svg_10.style.opacity)?'inherit':'hidden';
					me._svg_10.ggVisible=true;
				}
				else if (me._svg_10.ggCurrentLogicStateVisible == 2) {
					me._svg_10.style.visibility=(Number(me._svg_10.style.opacity)>0||!me._svg_10.style.opacity)?'inherit':'hidden';
					me._svg_10.ggVisible=true;
				}
				else if (me._svg_10.ggCurrentLogicStateVisible == 3) {
					me._svg_10.style.visibility=(Number(me._svg_10.style.opacity)>0||!me._svg_10.style.opacity)?'inherit':'hidden';
					me._svg_10.ggVisible=true;
				}
				else if (me._svg_10.ggCurrentLogicStateVisible == 4) {
					me._svg_10.style.visibility=(Number(me._svg_10.style.opacity)>0||!me._svg_10.style.opacity)?'inherit':'hidden';
					me._svg_10.ggVisible=true;
				}
				else {
		...
		me._visible_counters.appendChild(me._svg_10);
		...
		me._svg_1.logicBlock_visible = function() {
			...
			if (me._svg_1.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				else if (me._svg_1.ggCurrentLogicStateVisible == 2) {
					me._svg_1.style.visibility=(Number(me._svg_1.style.opacity)>0||!me._svg_1.style.opacity)?'inherit':'hidden';
					me._svg_1.ggVisible=true;
				}
				else if (me._svg_1.ggCurrentLogicStateVisible == 3) {
					me._svg_1.style.visibility=(Number(me._svg_1.style.opacity)>0||!me._svg_1.style.opacity)?'inherit':'hidden';
					me._svg_1.ggVisible=true;
				}
				else if (me._svg_1.ggCurrentLogicStateVisible == 4) {
					me._svg_1.style.visibility=(Number(me._svg_1.style.opacity)>0||!me._svg_1.style.opacity)?'inherit':'hidden';
					me._svg_1.ggVisible=true;
				}
				else {
		...
		me._visible_counters.appendChild(me._svg_1);
		...
		me._count_status.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getCurrentNode() == "node1")) && 
				((player.getVariableValue('my_count_1') > 0)) && 
			...
			if (me._count_status.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._count_status.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._count_status.style[domTransition]='';
				if (me._count_status.ggCurrentLogicStateVisible == 0) {
					me._count_status.style.visibility=(Number(me._count_status.style.opacity)>0||!me._count_status.style.opacity)?'inherit':'hidden';
					me._count_status.ggVisible=true;
				}
				else if (me._count_status.ggCurrentLogicStateVisible == 1) {
					me._count_status.style.visibility=(Number(me._count_status.style.opacity)>0||!me._count_status.style.opacity)?'inherit':'hidden';
					me._count_status.ggVisible=true;
				}
				else if (me._count_status.ggCurrentLogicStateVisible == 2) {
					me._count_status.style.visibility=(Number(me._count_status.style.opacity)>0||!me._count_status.style.opacity)?'inherit':'hidden';
					me._count_status.ggVisible=true;
				}
				else if (me._count_status.ggCurrentLogicStateVisible == 3) {
					me._count_status.style.visibility=(Number(me._count_status.style.opacity)>0||!me._count_status.style.opacity)?'inherit':'hidden';
					me._count_status.ggVisible=true;
				}
				else if (me._count_status.ggCurrentLogicStateVisible == 4) {
					me._count_status.style.visibility=(Number(me._count_status.style.opacity)>0||!me._count_status.style.opacity)?'inherit':'hidden';
					me._count_status.ggVisible=true;
				}
				else {
					me._count_status.style.visibility="hidden";
					me._count_status.ggVisible=false;
				}
			}
		}
		me._count_status.logicBlock_text = function() {
			...
			if (me._count_status.ggCurrentLogicStateText != newLogicStateText) {
				...
				if (me._count_status.ggCurrentLogicStateText == 0) {
					me._count_status.ggText="Start hunting for hidden eggs!";
		...
		me._counter_reset.onclick=function (e) {
			...
			player.setVariableValue('my_count_4', Number("0"));
			player.setVariableValue('my_count_4', Number("0"));
			player.setVariableValue('my_count_4', Number("0"));
			player.setVariableValue('my_count_4', Number("0"));
		}
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		els.innerHTML="Click and Drag to rotate. Click on any Eggs you might find. There are four Eggs in each spot.";
		el.appendChild(els);
		...
		me._text_2.logicBlock_text = function() {
			...
			if (me._text_2.ggCurrentLogicStateText != newLogicStateText) {
				...
				if (me._text_2.ggCurrentLogicStateText == 0) {
					me._text_2.ggText="Drag to rotate. Click on any Eggs you might find. There are four Eggs in each spot.";
					me._text_2__text.innerHTML=me._text_2.ggText;
					if (me._text_2.ggUpdateText) {
					me._text_2.ggUpdateText=function() {
						var hs="Drag to rotate. Click on any Eggs you might find. There are four Eggs in each spot.";
						if (hs!=this.ggText) {
							this.ggText=hs;
							this.ggTextDiv.innerHTML=hs;
							if (this.ggUpdatePosition) this.ggUpdatePosition();
					...
					me._text_2.ggText="Click and Drag to rotate. Click on any Eggs you might find. There are four Eggs in each spot.";
					me._text_2__text.innerHTML=me._text_2.ggText;
					if (me._text_2.ggUpdateText) {
					me._text_2.ggUpdateText=function() {
						var hs="Click and Drag to rotate. Click on any Eggs you might find. There are four Eggs in each spot.";
						if (hs!=this.ggText) {
							this.ggText=hs;
							this.ggTextDiv.innerHTML=hs;
							if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'1S0DxBr5K/nDJH08ALKTq1ZpBfNLkqbL30j3qvBMAv1dHjjm7f8Nq1X6vGcYxo8WDLR/E434P/brlHsdQeKQAAAAAElFTkSuQmCC';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
	...
	me.callChildLogicBlocksHotspot_ht_info_configloaded = function(){
		if(hotspotTemplates['ht_info']) {
			...
			for(i = 0; i < hotspotTemplates['ht_info'].length; i++) {
				if (hotspotTemplates['ht_info'][i]._tt_information0.logicBlock_position) {
	...
	me.callChildLogicBlocksHotspot_ht_info_mouseover = function(){
		if(hotspotTemplates['ht_info']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_info'].length; i++) {
				if (hotspotTemplates['ht_info'][i]._tt_information0.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_egg_1_configloaded = function(){
		if(hotspotTemplates['ht_egg_1']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_1'].length; i++) {
				if (hotspotTemplates['ht_egg_1'][i]._ht_info_image19.logicBlock_size) {
					hotspotTemplates['ht_egg_1'][i]._ht_info_image19.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_2_configloaded = function(){
		if(hotspotTemplates['ht_egg_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_2'].length; i++) {
				if (hotspotTemplates['ht_egg_2'][i]._ht_info_image18.logicBlock_size) {
					hotspotTemplates['ht_egg_2'][i]._ht_info_image18.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_3_configloaded = function(){
		if(hotspotTemplates['ht_egg_3']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_3'].length; i++) {
				if (hotspotTemplates['ht_egg_3'][i]._ht_info_image17.logicBlock_size) {
					hotspotTemplates['ht_egg_3'][i]._ht_info_image17.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_4_configloaded = function(){
		if(hotspotTemplates['ht_egg_4']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_4'].length; i++) {
				if (hotspotTemplates['ht_egg_4'][i]._ht_info_image16.logicBlock_size) {
					hotspotTemplates['ht_egg_4'][i]._ht_info_image16.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_5_configloaded = function(){
		if(hotspotTemplates['ht_egg_5']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_5'].length; i++) {
				if (hotspotTemplates['ht_egg_5'][i]._ht_info_image15.logicBlock_size) {
					hotspotTemplates['ht_egg_5'][i]._ht_info_image15.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_6_configloaded = function(){
		if(hotspotTemplates['ht_egg_6']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_6'].length; i++) {
				if (hotspotTemplates['ht_egg_6'][i]._ht_info_image14.logicBlock_size) {
					hotspotTemplates['ht_egg_6'][i]._ht_info_image14.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_7_configloaded = function(){
		if(hotspotTemplates['ht_egg_7']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_7'].length; i++) {
				if (hotspotTemplates['ht_egg_7'][i]._ht_info_image13.logicBlock_size) {
					hotspotTemplates['ht_egg_7'][i]._ht_info_image13.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_8_configloaded = function(){
		if(hotspotTemplates['ht_egg_8']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_8'].length; i++) {
				if (hotspotTemplates['ht_egg_8'][i]._ht_info_image12.logicBlock_size) {
					hotspotTemplates['ht_egg_8'][i]._ht_info_image12.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_9_configloaded = function(){
		if(hotspotTemplates['ht_egg_9']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_9'].length; i++) {
				if (hotspotTemplates['ht_egg_9'][i]._ht_info_image11.logicBlock_size) {
					hotspotTemplates['ht_egg_9'][i]._ht_info_image11.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_10_configloaded = function(){
		if(hotspotTemplates['ht_egg_10']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_10'].length; i++) {
				if (hotspotTemplates['ht_egg_10'][i]._ht_info_image10.logicBlock_size) {
					hotspotTemplates['ht_egg_10'][i]._ht_info_image10.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_11_configloaded = function(){
		if(hotspotTemplates['ht_egg_11']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_11'].length; i++) {
				if (hotspotTemplates['ht_egg_11'][i]._ht_info_image9.logicBlock_size) {
					hotspotTemplates['ht_egg_11'][i]._ht_info_image9.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_12_configloaded = function(){
		if(hotspotTemplates['ht_egg_12']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_12'].length; i++) {
				if (hotspotTemplates['ht_egg_12'][i]._ht_info_image8.logicBlock_size) {
					hotspotTemplates['ht_egg_12'][i]._ht_info_image8.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_13_configloaded = function(){
		if(hotspotTemplates['ht_egg_13']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_13'].length; i++) {
				if (hotspotTemplates['ht_egg_13'][i]._ht_info_image7.logicBlock_size) {
					hotspotTemplates['ht_egg_13'][i]._ht_info_image7.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_14_configloaded = function(){
		if(hotspotTemplates['ht_egg_14']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_14'].length; i++) {
				if (hotspotTemplates['ht_egg_14'][i]._ht_info_image6.logicBlock_size) {
					hotspotTemplates['ht_egg_14'][i]._ht_info_image6.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_15_configloaded = function(){
		if(hotspotTemplates['ht_egg_15']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_15'].length; i++) {
				if (hotspotTemplates['ht_egg_15'][i]._ht_info_image5.logicBlock_size) {
					hotspotTemplates['ht_egg_15'][i]._ht_info_image5.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_16_configloaded = function(){
		if(hotspotTemplates['ht_egg_16']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_16'].length; i++) {
				if (hotspotTemplates['ht_egg_16'][i]._ht_info_image4.logicBlock_size) {
					hotspotTemplates['ht_egg_16'][i]._ht_info_image4.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_17_configloaded = function(){
		if(hotspotTemplates['ht_egg_17']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_17'].length; i++) {
				if (hotspotTemplates['ht_egg_17'][i]._ht_info_image3.logicBlock_size) {
					hotspotTemplates['ht_egg_17'][i]._ht_info_image3.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_18_configloaded = function(){
		if(hotspotTemplates['ht_egg_18']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_18'].length; i++) {
				if (hotspotTemplates['ht_egg_18'][i]._ht_info_image2.logicBlock_size) {
					hotspotTemplates['ht_egg_18'][i]._ht_info_image2.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_19_configloaded = function(){
		if(hotspotTemplates['ht_egg_19']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_19'].length; i++) {
				if (hotspotTemplates['ht_egg_19'][i]._ht_info_image1.logicBlock_size) {
					hotspotTemplates['ht_egg_19'][i]._ht_info_image1.logicBlock_size();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_egg_20_configloaded = function(){
		if(hotspotTemplates['ht_egg_20']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_egg_20'].length; i++) {
				if (hotspotTemplates['ht_egg_20'][i]._ht_info_image0.logicBlock_size) {
					hotspotTemplates['ht_egg_20'][i]._ht_info_image0.logicBlock_size();
				}
			}
		}
	}
	...
	function SkinHotspotClass_ht_info(parentScope,hotspot) {
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			...
			''+
			...
			''+
			''+
			'M2wtMi4zOTMsMi4zOTNWLTI1ODMuODM3eiIgc3Ryb2tlPSIjMUExNzFCIiBzdHJva2Utd2lkdGg9IjAuMiIgc3Ryb2tlLWxpbmVqb2luPSJyb3VuZCIgc3Ryb2tlLWxpbmVjYXA9InJvdW5kIi8+CiAgIDwvZz4KICA8L2c+CiA8L2c+Cjwvc3ZnPgo=';
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
	...
	function SkinHotspotClass_ht_egg_1(parentScope,hotspot) {
		...
		me._ht_info_image19.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image19.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image19.ggCurrentLogicStateSize == 0) {
					me._ht_info_image19.style.width='7px';
					me._ht_info_image19.style.height='7px';
		...
		me._ht_egg_1.appendChild(me._ht_info_image19);
			me.hotspotTimerEvent=function() {
				...
				var hs='';
				if (me._ht_egg_1.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_1.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_1.style[domTransform]=hs;
			}
	...
	function SkinHotspotClass_ht_egg_2(parentScope,hotspot) {
		...
		me._ht_info_image18.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image18.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image18.ggCurrentLogicStateSize == 0) {
					me._ht_info_image18.style.width='7px';
					me._ht_info_image18.style.height='7px';
		...
		me._ht_egg_2.appendChild(me._ht_info_image18);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_2.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_2.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_2.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_3(parentScope,hotspot) {
		...
		me._ht_info_image17.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image17.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image17.ggCurrentLogicStateSize == 0) {
					me._ht_info_image17.style.width='7px';
					me._ht_info_image17.style.height='7px';
		...
		me._ht_egg_3.appendChild(me._ht_info_image17);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_3.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_3.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_3.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_4(parentScope,hotspot) {
		...
		me._ht_info_image16.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image16.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image16.ggCurrentLogicStateSize == 0) {
					me._ht_info_image16.style.width='7px';
					me._ht_info_image16.style.height='7px';
		...
		me._ht_egg_4.appendChild(me._ht_info_image16);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_4.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_4.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_4.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_5(parentScope,hotspot) {
		...
		me._ht_info_image15.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image15.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image15.ggCurrentLogicStateSize == 0) {
					me._ht_info_image15.style.width='7px';
					me._ht_info_image15.style.height='7px';
		...
		me._ht_egg_5.appendChild(me._ht_info_image15);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_5.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_5.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_5.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_6(parentScope,hotspot) {
		...
		me._ht_info_image14.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image14.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image14.ggCurrentLogicStateSize == 0) {
					me._ht_info_image14.style.width='7px';
					me._ht_info_image14.style.height='7px';
		...
		me._ht_egg_6.appendChild(me._ht_info_image14);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_6.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_6.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_6.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_7(parentScope,hotspot) {
		...
		me._ht_info_image13.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image13.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image13.ggCurrentLogicStateSize == 0) {
					me._ht_info_image13.style.width='7px';
					me._ht_info_image13.style.height='7px';
		...
		me._ht_egg_7.appendChild(me._ht_info_image13);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_7.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_7.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_7.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_8(parentScope,hotspot) {
		...
		me._ht_info_image12.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image12.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image12.ggCurrentLogicStateSize == 0) {
					me._ht_info_image12.style.width='7px';
					me._ht_info_image12.style.height='7px';
		...
		me._ht_egg_8.appendChild(me._ht_info_image12);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_8.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_8.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_8.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_9(parentScope,hotspot) {
		...
		me._ht_info_image11.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image11.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image11.ggCurrentLogicStateSize == 0) {
					me._ht_info_image11.style.width='7px';
					me._ht_info_image11.style.height='7px';
		...
		me._ht_egg_9.appendChild(me._ht_info_image11);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_9.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_9.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_9.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_10(parentScope,hotspot) {
		...
		me._ht_info_image10.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image10.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image10.ggCurrentLogicStateSize == 0) {
					me._ht_info_image10.style.width='7px';
					me._ht_info_image10.style.height='7px';
		...
		me._ht_egg_10.appendChild(me._ht_info_image10);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_10.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_10.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_10.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_11(parentScope,hotspot) {
		...
		me._ht_info_image9.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image9.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image9.ggCurrentLogicStateSize == 0) {
					me._ht_info_image9.style.width='7px';
					me._ht_info_image9.style.height='7px';
		...
		me._ht_egg_11.appendChild(me._ht_info_image9);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_11.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_11.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_11.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_12(parentScope,hotspot) {
		...
		me._ht_info_image8.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image8.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image8.ggCurrentLogicStateSize == 0) {
					me._ht_info_image8.style.width='7px';
					me._ht_info_image8.style.height='7px';
		...
		me._ht_egg_12.appendChild(me._ht_info_image8);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_12.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_12.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_12.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_13(parentScope,hotspot) {
		...
		me._ht_info_image7.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image7.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image7.ggCurrentLogicStateSize == 0) {
					me._ht_info_image7.style.width='7px';
					me._ht_info_image7.style.height='7px';
		...
		me._ht_egg_13.appendChild(me._ht_info_image7);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_13.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_13.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_13.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_14(parentScope,hotspot) {
		...
		me._ht_info_image6.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image6.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image6.ggCurrentLogicStateSize == 0) {
					me._ht_info_image6.style.width='7px';
					me._ht_info_image6.style.height='7px';
		...
		me._ht_egg_14.appendChild(me._ht_info_image6);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_14.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_14.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_14.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_15(parentScope,hotspot) {
		...
		me._ht_info_image5.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image5.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image5.ggCurrentLogicStateSize == 0) {
					me._ht_info_image5.style.width='7px';
					me._ht_info_image5.style.height='7px';
		...
		me._ht_egg_15.appendChild(me._ht_info_image5);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_15.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_15.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_15.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_16(parentScope,hotspot) {
		...
		me._ht_info_image4.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image4.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image4.ggCurrentLogicStateSize == 0) {
					me._ht_info_image4.style.width='7px';
					me._ht_info_image4.style.height='7px';
		...
		me._ht_egg_16.appendChild(me._ht_info_image4);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_16.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_16.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_16.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_17(parentScope,hotspot) {
		...
		me._ht_info_image3.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image3.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image3.ggCurrentLogicStateSize == 0) {
					me._ht_info_image3.style.width='7px';
					me._ht_info_image3.style.height='7px';
		...
		me._ht_egg_17.appendChild(me._ht_info_image3);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_17.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_17.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_17.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_18(parentScope,hotspot) {
		...
		me._ht_info_image2.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image2.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image2.ggCurrentLogicStateSize == 0) {
					me._ht_info_image2.style.width='7px';
					me._ht_info_image2.style.height='7px';
		...
		me._ht_egg_18.appendChild(me._ht_info_image2);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_18.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_18.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_18.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_19(parentScope,hotspot) {
		...
		me._ht_info_image1.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image1.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image1.ggCurrentLogicStateSize == 0) {
					me._ht_info_image1.style.width='7px';
					me._ht_info_image1.style.height='7px';
		...
		me._ht_egg_19.appendChild(me._ht_info_image1);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_19.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_19.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_19.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	function SkinHotspotClass_ht_egg_20(parentScope,hotspot) {
		...
		me._ht_info_image0.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._ht_info_image0.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_image0.ggCurrentLogicStateSize == 0) {
					me._ht_info_image0.style.width='7px';
					me._ht_info_image0.style.height='7px';
		...
		me._ht_egg_20.appendChild(me._ht_info_image0);
			me.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				var hs='';
				if (me._ht_egg_20.ggParameter) {
					hs+=parameterToTransform(me._ht_egg_20.ggParameter) + ' ';
				}
				hs+='scale(' + (1.0/Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ') ';
				me._ht_egg_20.style[domTransform]=hs;
			}
			me.hotspotTimerEvent();
	...
	me._count_status0.logicBlock_text();
	me._svg_12.logicBlock_visible();
	me._svg_11.logicBlock_visible();
	me._svg_10.logicBlock_visible();
	me._svg_1.logicBlock_visible();
	me._count_status.logicBlock_visible();
	...
	player.addListener('changenode', function(args) { me._screentint_eggfound.logicBlock_visible();me._screentint_info.logicBlock_visible();me._information.logicBlock_visible();me._eggfound.logicBlock_visible();me._visible_counters.logicBlock_visible();me._count_status0.logicBlock_text();me._svg_12.logicBlock_visible();me._svg_11.logicBlock_visible();me._svg_10.logicBlock_visible();me._svg_1.logicBlock_visible();me._count_status.logicBlock_visible();me._count_status.logicBlock_text();me._start.logicBlock_visible();me._alleggsfound.logicBlock_visible(); });
	...
	player.addListener('varchanged_vis_egg_popup', function(args) { me._screentint_eggfound.logicBlock_visible();me._eggfound.logicBlock_visible(); });
	...
	player.addListener('varchanged_my_count_1', function(args) { me._svg_12.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_2', function(args) { me._svg_11.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_3', function(args) { me._svg_10.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_4', function(args) { me._svg_1.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_5', function(args) { me._svg_12.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_6', function(args) { me._svg_11.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_7', function(args) { me._svg_10.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_8', function(args) { me._svg_1.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_9', function(args) { me._svg_12.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_10', function(args) { me._svg_11.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_11', function(args) { me._svg_10.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_12', function(args) { me._svg_1.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_13', function(args) { me._svg_12.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_14', function(args) { me._svg_11.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_15', function(args) { me._svg_10.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_16', function(args) { me._svg_1.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_17', function(args) { me._svg_12.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_18', function(args) { me._svg_11.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_19', function(args) { me._svg_10.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_count_20', function(args) { me._svg_1.logicBlock_visible();me._count_status.logicBlock_visible(); });
	player.addListener('varchanged_my_total_count', function(args) { me._count_status0.logicBlock_text();me._count_status.logicBlock_text();me._alleggsfound.logicBlock_visible(); });
	...
	player.addListener('mouseover', function(args) { me.callChildLogicBlocksHotspot_ht_info_mouseover();me.callChildLogicBlocksHotspot_ht_node_mouseover();me.callChildLogicBlocksHotspot_ht_egg_special_mouseover(); });
